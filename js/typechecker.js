...
function extractBytesData( bytes ) {
  ...
  if(type == 0) {
    if(subtype == 0){
      ...
      setReview(4, "Amount", amount/100000000);
      setReview(5, "Fee", fee/100000000);
    ...
    else if(subtype == 7)
    {
      ...
      setReview(5, "Buy Price", amount/100000000);
      setReview(6, "Fee", fee/100000000);
    ...
    if(subtype == 0)
    {
      ...
      setReview(5, "Amount (price)", amount + "(" + price/100000000 + ")");
      setReview(6, "Fee", fee/100000000);
    }
    else if(subtype == 1)
    {
    ...
    else if(subtype == 2)
    {
      ...
      setReview(4, "New Price", newprice/100000000);
      setReview(5, "Fee", fee/100000000);
    ...
    else if(subtype == 4)
    {
      ...
      setReview(5, "Price", price/100000000);
      setReview(6, "Fee", fee/100000000);
    ...
    else if(subtype == 5)
    {
      ...
      setReview(4, "Discount", discount/100000000);
      setReview(5, "Fee", fee/100000000);
    ...
    else if(subtype == 7)
    {
      ...
      setReview(4, "Refund Amount", discount/100000000);
      setReview(5, "Fee", fee/100000000);
  ...
  else if(type == 5)
  {
    ...
    else if(subtype == 1)
    {
      ...
      var amount = byteArrayToBigInteger(rest.slice(1+8, 1+16)).toString();
      setReview(4, "Amount per Unit", amount);
      setReview(5, "Fee", fee/100000000);
      if(rest.length > 17) msg = rest.slice(17);
    }
    else if(subtype == 2)
